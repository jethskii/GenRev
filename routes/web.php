...
use App\Http\Controllers\FallbackController; // single-action fallback
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('products/{product}')
        ...
        ->group(function () {
            ...
            // Back-compat aliases (older blades)
    ...
    Route::prefix('production')->name('production.')->controller(ProductionController::class)->group(function () {
        ...
        // Place non-numeric route before ID routes to avoid collisions
    ...
    /* 🔁 Legacy employee aliases (fixes "Route [employee] not defined") */
...
/* ----------------------------------------------------------------------------
 | Fallback (route-cache friendly; no closure)
 * ---------------------------------------------------------------------------*/
